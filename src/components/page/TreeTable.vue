<template>
    <el-table :data="data" border style="width: 100%" :row-style="showTr" class="table">
        <el-table-column v-for="(column, index) in columns" :key="column.dataIndex" :label="column.text" class="table">
    ...
    export default {
        ...
        computed: {
            ...
            data: function () {
                let me = this
                if (me.treeStructure) {
                    let data = DataTranslate.treeToArray(me.dataSource, null, null, me.defaultExpandAll)
                    // console.log(data)
                    return data
                }
