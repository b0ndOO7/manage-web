    ...
    export default {
        ...
        data() {
            return {
                ...
                spanArr:[],
                tableData: [
                    {id: '1', project_id:'', project:'fund', index:'', case_name: '查询用户信息', api_name:'login', testdata:'aaa=bbb', uri:'/a/login'},
                    {id: '2', project_id:'', project:'fund', index:'', case_name: '查询用户信息', api_name:'query', testdata:'aaa=bbb', uri:'/a/query'},
                    {id: '3', project_id:'', project:'fund', index:'', case_name: '查询用户信息', api_name:'logout', testdata:'aaa=bbb', uri:'/a/logout'},
                    {id: '4', project_id:'', project:'usercenter', index:'', case_name: '登录', api_name:'login', testdata:'aaa=bbb', uri:'/a/login'}
                ],
                select_project:'',
                search_word: '',
                cur_page: 1,
        ...
        methods: {
            ...
            handleAdd(index, row) {
                ...
                for (let i=index+1, length=this.tableData.length; i<length; i++) {
                    ...
                    if (record.case_name == row.case_name && record.project_id == row.project_id) {
                        // this.tableData[i].index = row.index+(i-index);
                        console.log(record);
                        this.$set(this.tableData[i], 'index', record.index+1);
                        console.log(record);
                    }
                }
            },
